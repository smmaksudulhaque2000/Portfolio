...
const Contact = () => {
    ...
    return (
        <div id="contact" className="py-16 px-8 md:px-24 bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white">
            <motion.h3
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 bg-gray-800 p-8 rounded-xl shadow-xl">
                ...
                >
                    <div className="flex items-center bg-gray-700 p-4 rounded-lg shadow-md">
                        ...
                        <span className="text-xs lg:text-lg">smmaksudulhaque2000@gmail.com</span>
                    </div>
                    <div className="flex items-center bg-gray-700 p-4 rounded-lg shadow-md">
                ...
                >
                    ...
                    <button
                        ...
                        disabled={loading}
                    >
                        {loading ? "Sending..." : "Send Message"} <FaPaperPlane className="ml-2" />
                    </button>
                </motion.form>
            </div>
        </div>
