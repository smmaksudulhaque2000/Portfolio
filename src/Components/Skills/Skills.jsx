...
import { FaReact, FaNodeJs, FaDatabase, FaGitAlt, FaHtml5, FaCss3Alt, FaJsSquare, FaCode } from "react-icons/fa";
...
const skillsData = [
  {
    ...
    skills: [
      ...
      { name: "Tailwind", icon: <RiTailwindCssFill className="text-teal-400 text-5xl" /> },
    ],
  },
  {
    category: "Backend",
...
const Skills = () => {
  return (
    <div id="skills" className="py-16 px-8 md:px-24 bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white">
      <motion.h3
      ...
      <div className="grid md:grid-cols-3 gap-12">
        {skillsData.map((category, index) => (
          ...
          >
            <h4 className="text-2xl font-semibold text-blue-400 mb-6">{category.category}</h4>
